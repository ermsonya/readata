    ...
    <div class=" row">
       ...
       <div class="posts col-9">
         <div class="buttin row">
           <a href="create.php" class="btn btn-secondary col-2">Add category</a>
           <span class="col-1"></span>
            <a href="index.php" class="btn btn-secondary col-2" >Manage Categories</a>
         </div>
             ...
             <div class="col">
             <input name="name" value="<?=$name;?>" type="text" class="form-control" placeholder="title" aria-label="Category">
             </div>
             <div class="col">
    <button name="topic-create" class="btn btn-primary"  type="submit">Save catagory</button>
  </div>
