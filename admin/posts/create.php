         ...
         <div class="buttin row">
           ...
           <span class="col-1"></span>
            <a href="index.php" class="btn btn-secondary col-2" >Manage Posts</a>
             ...
             <div class="col mb-4">
             <input name="title" type="text" class="form-control" placeholder="title" aria-label="Post's name">
             </div>
             <div class="col">
...
<div class="form-check">
    <input name="publish" class="form-check-input" type="checkbox" id="flexCheckChecked" value="1" checked>
